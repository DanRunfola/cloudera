...
# pip install ...
# ==========
pip3 install ${wd}/geomesa_pyspark-2.4.0.tar.gz
echo "----------------------------------------"
...
conda deactivate
echo "----------------------------------------"
echo "Create pyspark file and main spark-submit file"
# create pyspark file
cat << EOF > ps-${env}
pyspark \
--driver-memory=100g \
...
--jars ${wd}/geomesa-accumulo-spark-runtime_2.11-2.4.0.jar,${wd}/geomesa-spark-converter_2.11-2.4.0.jar,/opt/cloudera/parcels/CDH-6.2.0-1.cdh6.2.0.p0.967373/jars/httpclient-4.5.3.jar,/opt/cloudera/parcels/CDH-6.2.0-1.cdh6.2.0.p0.967373/jars/commons-httpclient-3.1.jar
